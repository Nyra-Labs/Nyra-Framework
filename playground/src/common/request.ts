...
const API_BASE_URL = process.env.NEXT_PUBLIC_NYRA_DEV_SERVER_URL || 'http://localhost:49483';
...
export const apiFetchAddonsExtensions = async (): Promise<AddonDef.Module[]> => {
  let resp: any = await axios.get(`/api/playground/v1/addons/extensions`)
...
export const apiCheckCompatibleMessages = async (payload: {
  ...
  let resp: any = await axios.post(`/api/playground/v1/messages/compatible`, payload)
  resp = (resp.data) || {}
  return resp
}

export const apiFetchGraphs = async (): Promise<Graph[]> => {
  console.log("Fetching graphs from:", `${API_BASE_URL}/api/playground/v1/graphs`);
  let resp: any = await axios.get(`${API_BASE_URL}/api/playground/v1/graphs`);
...
export const apiFetchGraphNodes = async (graphId: string): Promise<Node[]> => {
  console.log("Fetching graph nodes from:", `${API_BASE_URL}/api/playground/v1/graphs/${graphId}/nodes`);
  let resp: any = await axios.get(`${API_BASE_URL}/api/playground/v1/graphs/${graphId}/nodes`);
...
export const apiFetchGraphConnections = async (graphId: string): Promise<Connection[]> => {
  let resp: any = await axios.get(`/api/playground/v1/graphs/${graphId}/connections`)
...
export const apiUpdateGraph = async (graphId: string, updates: Partial<Graph>) => {
  ...
  let resp: any = await axios.put(`/api/playground/v1/graphs/${graphId}`, payload)
  resp = (resp.data) || {}
  return resp
}
...
> => {
  let resp: any = await axios.get(`/api/playground/v1/addons/default-properties`)
...
export const apiSaveProperty = async () => {
  let resp: any = await axios.put(`/api/playground/v1/property`)
  resp = (resp.data) || {}
  return resp
}

export const apiReloadPackage = async (): Promise<void> => {
  console.log("Reloading packages from:", `${API_BASE_URL}/api/playground/v1/packages/reload`);
  await axios.post(`${API_BASE_URL}/api/playground/v1/packages/reload`);
};
