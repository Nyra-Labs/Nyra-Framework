...
class Model:
    def __init__(self, nyra_env, region_id, dbinstance_id, client):
    ...
    def init_vector_database(self, account, account_password) -> None:
        try:
            ...
            self.nyra_env.log_error(f"Error: {e}")
            return e
    ...
    def query_collection_data(
        ...
        try:
            ...
            self.nyra_env.log_debug(f"query_collection response code: {response.status_code}")
