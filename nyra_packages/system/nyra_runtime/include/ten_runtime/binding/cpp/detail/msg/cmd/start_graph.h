...
#include "nyra_runtime/msg/cmd/start_graph/cmd.h"
...
class cmd_start_graph_t : public cmd_t {
 private:
  ...
  explicit cmd_start_graph_t(nyra_shared_ptr_t *cmd) : cmd_t(cmd) {}
