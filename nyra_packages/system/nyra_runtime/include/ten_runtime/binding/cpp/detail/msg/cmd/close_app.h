...
#include "nyra_runtime/msg/cmd/close_app/cmd.h"
...
class cmd_close_app_t : public cmd_t {
 private:
  ...
  explicit cmd_close_app_t(nyra_shared_ptr_t *cmd) : cmd_t(cmd) {}
 ...
 public:
  ...
  explicit cmd_close_app_t(ctor_passkey_t /*unused*/)
      : cmd_t(nyra_cmd_close_app_create()) {}

  ~cmd_close_app_t() override = default;

  // @{
  cmd_close_app_t(nyra_cmd_close_app_t *cmd) = delete;
