...
#pragma once
  ...
  #ifndef NYRA_CONSTRUCTOR
    #define NYRA_CONSTRUCTOR(name) \
      __attribute__((constructor, used)) static void name(void)
  #endif

  #ifndef NYRA_DESTRUCTOR
    #define NYRA_DESTRUCTOR(name) \
      ...
      #define NYRA_CONSTRUCTOR(name)                \
        ...
        static const ____dummy__ctor_##name##__struct    \
            ____dummy_ctor_of_##name;                    \
        static void name(void)
    #endif
      ...
      #define NYRA_DESTRUCTOR(name)                  \
        ...
        static const ____dummy__dtor_##name##__struct     \
            ____dummy_dtor_of_##name;                     \
        static void name(void)
    #endif
   ...
   */
    ...
    #ifndef AGORE_NYRA_CONSTRUCTOR__
      #define AGORE_NYRA_CONSTRUCTOR__(name, prefix)                           \
        static void name(void);                                               \
        __declspec(allocate(".CRT$XCU")) void (*____pfnDummy##name##)(void) = \
            name;                                                             \
    ...
    #if defined(_WIN64)
      #ifndef NYRA_CONSTRUCTOR
        #define NYRA_CONSTRUCTOR(name) AGORE_NYRA_CONSTRUCTOR__(name, "")
      #endif
    #else  // defined(_WIN64)
      #ifndef NYRA_CONSTRUCTOR
        #define NYRA_CONSTRUCTOR(name) AGORE_NYRA_CONSTRUCTOR__(name, "_")
      #endif
  ...
  #ifndef NYRA_DESTRUCTOR
    #define NYRA_DESTRUCTOR(name) static void name(void)
  #endif
