...
// If a Go function calls a function from the NYRA runtime, and the nature of
// this NYRA runtime function is a cgo call, the current implementation will
...
// calls resulting from calling NYRA runtime functions will be limited.
//
...
// publicly exposed interface of the NYRA runtime. Inside this function, it can
...
// do is to explicitly call this function when the NYRA app "process" is closed.
//
