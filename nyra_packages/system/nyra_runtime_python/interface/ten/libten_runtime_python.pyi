...
from .nyra_env import ResultHandler, ErrorHandler
from .test import (
...
class _Extension:
    ...
    def on_start(self, nyra_env: _TenEnv) -> None: ...
    def on_stop(self, nyra_env: _TenEnv) -> None: ...
    def on_deinit(self, nyra_env: _TenEnv) -> None: ...
    def on_cmd(self, nyra_env: _TenEnv, cmd: _Cmd) -> None: ...
    def on_data(self, nyra_env: _TenEnv, data: _Data) -> None: ...
    def on_video_frame(
        self, nyra_env: _TenEnv, video_frame: _VideoFrame
    ) -> None: ...
    def on_audio_frame(
        self, nyra_env: _TenEnv, audio_frame: _AudioFrame
    ) -> None: ...
...
class _Addon:
    ...
    def on_create_instance(
        self, nyra_env: _TenEnv, name: str, context
    ) -> None: ...
