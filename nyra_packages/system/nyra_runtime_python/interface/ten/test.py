...
from libnyra_runtime_python import _ExtensionTester, _TenEnvTester
...
class ExtensionTester(_ExtensionTester):
    ...
    @final
    def _on_test_app_configure(self, nyra_env_tester: TenEnvTester) -> None:
        self.on_start(nyra_env_tester)
    ...
    def on_start(self, nyra_env_tester: TenEnvTester) -> None:
        nyra_env_tester.on_start_done()

    def on_cmd(self, nyra_env_tester: TenEnvTester, cmd: Cmd) -> None:
        pass

    def on_data(self, nyra_env_tester: TenEnvTester, data: Data) -> None:
        pass

    def on_audio_frame(
        self, nyra_env_tester: TenEnvTester, audio_frame: AudioFrame
    ) -> None:
        pass

    def on_video_frame(
        self, nyra_env_tester: TenEnvTester, video_frame: VideoFrame
    ) -> None:
        pass
