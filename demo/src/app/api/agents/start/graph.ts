...
export const getGraphProperties = (
    ...
    let localizationOptions = {
        "greeting": "Hey, I\'m NYRA Agent, I can speak, see, and reason from a knowledge base, ask me anything!",
