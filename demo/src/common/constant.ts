...
export const GITHUB_URL = "https://github.com/nyra-framework/"
export const API_GH_GET_REPO_INFO =
  "https://api.github.com/repos/nyra-framework/nyra-agent"
...
export const DESCRIPTION = "A Realtime Conversational AI Agent powered by Nyra"
